import { Settings, ArrowUpCircle, User } from 'lucide-react';
  ...
  return (
    <div className="flex-shrink-0" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0)' }}>
      ...
      <div className="hidden px-2 pt-1.5 md:block">
        <div className="flex w-full items-center gap-2 rounded-lg px-2.5 py-1.5 text-muted-foreground">
      ...
      <div className="px-3 pt-3 md:hidden">
        <div className="flex h-12 w-full items-center gap-3.5 rounded-xl bg-muted/40 px-4">
