import { Bell, Bot, GitBranch, Key, ListChecks, Palette, Puzzle, Users } from 'lucide-react';
...
const ADMIN_NAV_ITEM: NavItem = { id: 'admin', labelKey: 'mainTabs.admin', icon: Users };
